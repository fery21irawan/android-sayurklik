...
public class ProgressBarHelper extends View {
    //actual dot radius
    ...
    public ProgressBarHelper(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ProgressBarHelper(Context context, AttributeSet attrs, int defStyleAttr) {
